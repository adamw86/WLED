...
Network name (SSID, empty to not connect):<br><input name="CS" 
value="NETGEAR18" maxlength="32"><br>Network password:<br><input 
type="password" name="CP" value="curlymoon921" maxlength="63"><br>
...
value="Frame" maxlength="63"><br>Access Point WiFi channel: <input name="AC" 
...
</option><option value="2" selected="selected">Always</option><option value="3">
